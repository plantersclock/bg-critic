...
class BGCard extends Component {
  ...
  render() {
    ...
    if (this.props.bg !== undefined && this.props.bg !== null) {
      isLoaded = true;
      description = this.convert(bg.description);
        ...
        {isLoaded ? (
          <div>
            <div className="bg-card-image-parent">
              <div
                className="bg-card-image-background"
            ...
            <a
              ...
              href={"https://www.boardgamegeek.com/boardgame/" + bg.bgg_id}
            >
              ...
              <Grid style={{ marginBottom: 24 }} item container xs={12}>
                <Grid item xs={12} sm={9}>
                  <Typography gutterBottom>
                    <span className="bggcard-game-title">
                      {topX - order}. {bg.name}
                    </span>
                  </Typography>
                  <Typography
                ...
                <Hidden xsDown>
                  <Grid item container justify="flex-end" xs={3}>
                    <iframe
                      title={"amazon link for " + bg.name}
                      style={{ width: 120, height: 240, paddingLeft: 22 }}
                      marginWidth="0"
                      marginHeight="0"
                      scrolling="no"
                      frameBorder="0"
